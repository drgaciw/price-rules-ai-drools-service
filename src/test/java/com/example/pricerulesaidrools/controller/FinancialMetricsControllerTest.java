...
class FinancialMetricsControllerTest {
    ...
    void calculateMetrics_ShouldReturnMetricsResponse() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/financial-metrics/calculate")
                ...
                .andExpected(jsonPath("$.metrics.acv").value(12000))
                .andExpected(jsonPath("$.metrics.clv").value(240000))
                .andExpected(jsonPath("$.pricing.basePrice").value(12000))
                .andExpected(jsonPath("$.pricing.finalPrice").value(12000))
                .andExpected(jsonPath("$.pricing.currency").value("USD"));
    }
